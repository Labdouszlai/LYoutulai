...
### Lightweight Mode
Replace resource-heavy video playback with the song's album art. When enabled (`Settings > General > Enable lightweight mode`):
- Videos are hidden and replaced by the cover thumbnail
- Player controls (play, pause, next, previous) remain fully functional on hover
- Reduces GPU/CPU usage significantly on lower-end machines
...
| Architecture | File |
|-------------|------|
| x64 | `LYoutulai-v1.0.0-win-x64.zip` |
| x86 | `LYoutulai-v1.0.0-win-x86.zip` |

Extract the ZIP and run `YTMDesktop.bat` — no installation required.

---

## Building from Source

This is a portable Electron app. To build from source:

1. Clone the repository
2. Download the correct Electron binary for your architecture
3. Place the Electron runtime files in the project root
4. Run `YTMDesktop.bat`
...
**Lightweight optimization, audio effects, and ongoing maintenance:** [l'abdouszlai](https://github.com/Labdouszlai)
